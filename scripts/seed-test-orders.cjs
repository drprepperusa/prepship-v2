...
function makeOrder(i) {
  ...
  const raw = {
    ...
    billTo: { name: `${first} ${last}`, company: null, street1: '123 Test St', city, state, postalCode: zip, country: 'US', phone: null, residential: true },
    shipTo: {
      name: `${first} ${last}`, company: null,
      street1: '123 Test St', street2: null, street3: null,
...
function makeBatchOrder(orderId, group, nameIdx) {
  ...
  const raw = {
    ...
    billTo: { name: `${first} ${last}`, street1: '456 Batch Ave', city: group.city, state: group.state, postalCode: group.zip, country: 'US', phone: null, residential: true },
    shipTo: {
      name: `${first} ${last}`, company: null,
      street1: '456 Batch Ave', street2: null, street3: null,
